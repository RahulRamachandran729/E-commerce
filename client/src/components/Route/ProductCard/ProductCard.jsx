        ...
        <Link to={`/products/${product_name}`}>
          ...
          <div className='flex'>
            ...
            <div className='py-2 flex items-center justify-between'>
              ...
              <span className='font-[400] text-[17px] text-[#6fdc6f]'>
            ...
            <div>
            {
              click ?(
                <AiFillHeart size={22} className='cursor-pointer
                 absolute right-2 top-5' onClick={()=>setClick(!click)}
                color={click ? "red":"#333" }title="remove from wishlist"/>
              ):(
            ...
            className="cursor-pointer right-2 absolute top-14"
            ...
            />
            {
              open ? <ProductDetailsCard data={data}
